...
class Emaillogin extends StatefulWidget {
  const Emaillogin({super.key, required this.title});
...
class _EmailloginState extends State<Emaillogin> {
  ...
  Widget buildInstructionText() {
    return Text(
      "Enter your email and authenticate to receive your OTP (One Time Password)"
  ...
  Widget buildOtp() {
    return Column(
      ...
      children: [
        Text(
          "Enter the code (OTP) you just received in your mail",
          style: const TextStyle(color: Colors.black, fontSize: 16),
        ),
          ...
          child: Row(
            ...
            children: [
              ...
              Flexible(
                child: Text.rich(
                  TextSpan(
                    text: "The email address you have entered is not in our system. If you are "
                        "new user, please register your email ", // Normal text
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(children: [
                            Text(
                              "Please enter a valid email address to access your portal",
                              style: const TextStyle(color: Colors.black, fontSize: 16),
                            ),
                            SizedBox(
                              height: 20,
                              ...
                              decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(
                                  ...
                                  borderSide: BorderSide(
                                    color: CustomColors.ezpurple, // Outline color when not focused
                                    width: 1.5,
                                  ),
                                ),
                              ...
                              onPressed: () {
                                setState(() {
                                  if (emailedt.text.trim().isEmpty) {
                                    showError = false;
                                    showOtp = false;
                                  } else if (emailedt.text.trim() != staticEmail) {
                                    showError = true;
                                    showOtp = false;
                                  } else {
                                    showError = false;
