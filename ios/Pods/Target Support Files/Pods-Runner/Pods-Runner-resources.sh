...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../.symlinks/plugins/flutter_svprogresshud/ios/SVProgressHUD/SVProgressHUD.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/fluttertoast/fluttertoast_privacy.bundle"
